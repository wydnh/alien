...
def create_fleet(ai_settings, screen, aliens):
    ...
    randint_number_aliens_x = randint(0, number_aliens_x)

    number_cows = get_number_rows(ai_settings, alien.rect.height)
    randint_number_cows = randint(0, number_cows)

    # 创建第一行外星人
    for cow_number in range(randint_number_cows):
        for alien_number in range(randint_number_aliens_x):
